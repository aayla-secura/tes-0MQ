...
#define TES_CAP_REQ_OK     0 // accepted (async conv) or all OK
#define TES_CAP_REQ_EINV   1 // malformed request
#define TES_CAP_REQ_EABORT 2 // file exists and not overwriting
#define TES_CAP_REQ_EPERM  3 // a filename is not allowed
#define TES_CAP_REQ_EINIT  4 // error initializing
